...
namespace HMS_DataAccess
{
    ...
    {
        public static void GetUserInfoByID(int ID,ref int PersonID,ref string UserName,ref string Password,ref byte isActive,ref Exception  ErrorAccoured)
        {
        ...
        public static void GetUserInfoBynameAndPasssword( string UserName,  string Password,ref int ID, ref int PersonID, ref byte isActive, ref Exception ErrorAccoured)
        {
            string conn = ConfigurationManager.AppSettings["ConnectionString"];
            try
            {
